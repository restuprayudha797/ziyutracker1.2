...
<!-- Favicon-->
<link rel="icon" href="<?= base_url('assets/root') ?>/icon/logotrack.png" type="image/x-icon" />

<!-- Title -->
<title>ZIYU TRACKER</title>

<!-- Bootstrap css -->
<link href="<?= base_url('assets/root') ?>/plugins/bootstrap-4.1.3/css/bootstrap.min.css" rel="stylesheet" />

<!-- Style css -->
<link href="<?= base_url('assets/root') ?>/css/style.css" rel="stylesheet" />

<!-- Default css -->
<link href="<?= base_url('assets/root') ?>/css/default.css" rel="stylesheet">

<!-- Horizontal css -->
<link id="effect" href="<?= base_url('assets/root') ?>/plugins/horizontal-menu/dropdown-effects/fade-up.css" rel="stylesheet" />
<link href="<?= base_url('assets/root') ?>/plugins/horizontal-menu/horizontal.css" rel="stylesheet" />

<!-- Owl-carousel css-->
<link href="<?= base_url('assets/root') ?>/plugins/owl-carousel/owl.carousel.css" rel="stylesheet" />

<!-- Bootstrap-daterangepicker css -->
<link rel="stylesheet" href="<?= base_url('assets/root') ?>/plugins/bootstrap-daterangepicker/daterangepicker.css">

<!-- Bootstrap-datepicker css -->
<link rel="stylesheet" href="<?= base_url('assets/root') ?>/plugins/bootstrap-datepicker/bootstrap-datepicker.css">

<!-- P-scroll css -->
<link href="<?= base_url('assets/root') ?>/plugins/p-scroll/p-scroll.css" rel="stylesheet" type="text/css">

<!-- Font-icons css -->
<link href="<?= base_url('assets/root') ?>/css/icons.css" rel="stylesheet">

<!-- Rightsidebar css -->
<link href="<?= base_url('assets/root') ?>/plugins/sidebar/sidebar.css" rel="stylesheet">

<!-- Nice-select css  -->
<link href="<?= base_url('assets/root') ?>/plugins/jquery-nice-select/css/nice-select.css" rel="stylesheet" />
